...
- [X] **Phase 1: Spider-Man** 
HTML Basics, HTML Forms and Inputs, CSS Basics, CSS Layouts,  Advanced CSS Styling, Responsive Design, CSS Frameworks, HTML5 & CSS3 Features  
- [X] **Phase 2: JavaScript Surgeons** 
JavaScript Basics, Functions, Arrays and Objects, Asynchronous JavaScript, JavaScript and the DOM, Event Handling, Object-Oriented JavaScript, Advanced JavaScript Concepts, JavaScript ES6+ Features
